...
class Genres(IMDBDatetime):
    ...
    """
    genre = models.CharField(max_length=25, unique=True, help_text="Will store all genre")
...
class Movies(IMDBDatetime):
    ...
    genre = models.ManyToManyField(Genres, db_index=True,
                                   help_text="Will maintain many to many relation")
    ...
    is_active = models.BooleanField(default=True, help_text="is this record are active")
    is_deleted = models.BooleanField(default=False, help_text="Mark record deleted")
    ...
    def get_all_movies(self):
        ...
        """
        return self.objects.filter(is_active=True, is_deleted=False)
